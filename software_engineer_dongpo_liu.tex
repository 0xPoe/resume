...
\begin{itemize}[parsep=0.25ex]
      \item \en{\textbf{Programming Languages}:
                  Experienced in Go/Rust/TypeScript/JavaScript,
                  \textbf{multilingual} (can adapt to any language)}
            \zh{\textbf{编程语言}:
                  熟悉 Go/Rust/TypeScript/JavaScript
...
\zh{\textbf{产出：}}
\begin{itemize}
      \item \en{Designed a statistics update optimization for tables with over 2 billion rows, reducing update time from 718 seconds to 45 seconds and improving performance by 15.8x.}
      \zh{设计统计信息更新优化方案，将 20 亿行以上表的统计信息更新耗时从 718 秒降至 45 秒，性能提升 15.8 倍。}
      \item \en{Designed and implemented a broadcast-based mechanism for cross-node statistics refresh, resolving a long-standing issue that had persisted for five years.}
      \zh{设计并实现基于广播机制的跨节点统计信息刷新方案，解决了持续 5 年的历史遗留问题。}
...
\en{\datedsubsection{\textbf{\href{https://www.morningstar.com/}{Morningstar, Inc. - Financial Services - Full-Stack Engineer(Java/JavaScript)}}}{June 2019 -- July 2020}}
\zh{\datedsubsection{\textbf{\href{https://www.morningstar.com/}{晨星资讯（Morningstar, Inc.）- 金融服务 - 前后端开发工程师（Java/JavaScript）}}}{2019/06 -- 2020/07}}
\en{\textsl{Joined Morningstar, Inc. after graduation, developing and maintaining data presentation components and front-end infrastructure with Java and Vue.js, including user behavior tracking and automated release workflows.}}
\zh{\textsl{毕业后加入晨星资讯（Morningstar, Inc.），负责基于 Java 和 Vue.js 的数据展示组件及前端基础设施开发维护，参与用户行为追踪和自动化发布流程建设。}}

\section{\faGithubAlt\ \en{Open Source Projects}\zh{开源项目}}
\en{\datedsubsection{\textbf{Cargo(Rust) - Maintainer}}{{\href{https://github.com/search?q=repo:rust-lang/cargo+repo:rust-lang/rust+author:0xPoe&type=commits}{301+ commits}}}}
\zh{\datedsubsection{\textbf{Cargo(Rust) - 维护者}}{{\href{https://github.com/search?q=repo:rust-lang/cargo+repo:rust-lang/rust+author:0xPoe&type=commits}{301+ commits}}}}
...
\en{\datedsubsection{\textbf{crates.io(Rust/JS) - Previous Maintainer}}{{\href{https://github.com/rust-lang/crates.io/commits?author=0xPoe}{131+ commits}}}}
\zh{\datedsubsection{\textbf{crates.io(Rust/JS) - 前维护者}}{{\href{https://github.com/rust-lang/crates.io/commits?author=0xPoe}{131+ commits}}}}
