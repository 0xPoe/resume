...
\zh{\datedsubsection{\textbf{\href{https://pingcap.com/zh/}{北京平凯星辰科技发展有限公司（PingCAP Inc.）- 数据库 - 数据库研发}}}{2021/07 -- 至今}}
...
\begin{itemize}
      ...
      \item \en{Responsible for the day-to-day maintenance of the project: issue tracking and resolution, code review and oncall to resolve customer issues.}
            \zh{负责项目日常的维护：issue 追踪和解决、代码审阅和 oncall 解决客户问题。}
